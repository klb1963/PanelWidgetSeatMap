...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-seatmap-panelwidget-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-seatmap-panelwidget-web-module/translations');
